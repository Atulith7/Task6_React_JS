                                        ...
                                        <div class="row text-light">
                                            ...
                                            <div class="col-12 p-4">
                                                <div class="about-me pt-4 pt-md-0">
                                                    ...
                                                    <p>
                                                    I'm an open-minded individual who values personal growth and connections. My passion and curiosity drive me to embrace new experiences. Every day, I paint my unique journey with enthusiasm, resilience, and a commitment to self-discovery, cherishing the meaningful relationships that enrich my life.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div className="container m-5">
                ...
                <div className="row">
                    <ul className="col-12 col-xxl-6 list-group mt-5 ps-4">
                        ...
                        <li className="list-group-item"><span className="fw-bold">Full Name: Aravalli Atulith</span></li>
                        <li className="list-group-item"><span className="fw-bold">Birthday: 29th February 2004</span></li>
                        <li className="list-group-item"><span className="fw-bold">City: Vijayawada</span></li>
                    </ul>
                    <ul className="col-12 col-xxl-6 list-group mt-5 pe-4">
                        <li className="list-group-item"><span className="fw-bold">Git Profile: </span><a className="link" href="https://github.com/Atulith7">Click here</a></li>
